...
const HeroImage: FC<HeroImageProps> = ({}) => {
  return (
    <div
      className={`h-fit md:flex  flex-col relative z-5  pt-[28px] justify-center items-center text-white/80  font-bold lg:absolute lg:top-0 lg:bottom-0 lg:left-[54px] lg:h-screen`}
    >
      <div
        style={{ direction: "ltr" }}
